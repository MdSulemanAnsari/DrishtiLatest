...
class SoldItemMyStockAdapter(var listRingBuying:ArrayList<OrderBuyingModel>): RecyclerView.Adapter<SoldItemMyStockAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding= DataBindingUtil.inflate<OrderBuyingItemAdapterBinding>(LayoutInflater.from(parent.context), R.layout.order_buying_item_adapter,parent,false)
        return ViewHolder(binding)
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        var data=listRingBuying[position]
